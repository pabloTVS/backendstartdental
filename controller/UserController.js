...
var UserController = /** @class */ (function () {
    ...
    UserController.new = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    e_3 = _b.sent();
                    return [2 /*return*/, res.status(409).json({ message: 'Usuario ya existente.' })];
                case 5:
                    // All ok
    ...
    UserController.delete = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    UserController.changePassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, password, userRepository, user, e_7, validationOps, errors;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
